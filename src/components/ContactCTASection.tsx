    ...
    <section className="relative bg-gradient-to-br from-[#323832] via-[#407842] to-[#49a14d] py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          ...
          <div>
            ...
            <p className="text-gray-300 text-base leading-relaxed mb-8">
              Ready to transform your life through holistic healing? We&apso;re
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">+1 (555) 123-RETREAT</p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="sound" className="bg-gray-400">
                    Sound Healing Retreat
                  </option>
                  <option value="meditation" className="bg-gray-400">
                    Meditation Intensive
                  </option>
                  <option value="wellness" className="bg-gray-400">
                    Yoga & Wellness
                  </option>
                  <option value="holistic" className="bg-gray-400">
                    Holistic Wellness Package
                  </option>
                  <option value="custom" className="bg-gray-400">
                    Custom Program
                  </option>
                </select>
              </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-3xl p-12 text-center border border-white/20">
          ...
          <button className="bg-yellow-300 inline-flex items-center gap-3 bg-gradient-to-r  hover:from-yellow-400 to-yellow-500 text-gray-900 font-bold px-8 py-4 rounded-full hover:scale-130 transition-all duration-300 shadow-lg hover:shadow-2xl cursor-pointer">
