...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Decorative circles */}
      <div className="absolute top-20 left-20 w-24 h-24 rounded-full bg-green-400/30 blur-2xl" />
      <div className="absolute top-1/2 right-32 w-20 h-20 rounded-full bg-teal-500/40 blur-xl" />
      <div className="absolute bottom-32 right-20 w-32 h-32 rounded-full bg-yellow-600/20 blur-2xl" />
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-4xl mx-auto leading-relaxed">
          ...
          meditation, <br />
          yoga, and live music sessions designed to alleviate stress and restore
          your <br />
          inner balance.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <div className="px-6 py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white flex items-center gap-3">
            <svg
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-24">
          <button className="px-8 py-4 bg-[#45a030] hover:bg-[#45a049] text-white rounded-full font-semibold text-lg transition-all duration-300 flex items-center gap-2 shadow-lg hover:scale-105 cursor-pointer">
            Book Your Retreat
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <button className="px-8 py-4 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white rounded-full font-semibold text-lg border border-white/30 transition-all duration-300 flex items-center gap-2 cursor-pointer">
        ...
        {/* Stats */}
        <div className="flex flex-wrap justify-center items-center gap-8 text-gray-400 mt-8">
